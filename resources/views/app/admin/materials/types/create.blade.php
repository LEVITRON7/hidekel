...
<center><h3> Agregando nuevo tipo de material </h3></center>
            @include('app.admin.partials.errormessages')
            {!! Form::open(['route' => 'admin.materials.types.create', 'method' => 'POST', 'class' => 'form-horizontal', 'role'=> 'form', 'id' => 'creatematerialtype']) !!}            
